 ...
 */
template<const char *Name, typename... Ts> class AComponentPool : virtual public IComponentPool
{
public:
  /**
...
private:
  ...
  template<std::size_t... Indices> void addChunkImpl(size_t elemCount, std::index_sequence<Indices...> /*unused*/)
  {
