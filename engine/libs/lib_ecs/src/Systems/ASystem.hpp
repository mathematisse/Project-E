...
template<typename T> struct all_derived_from_base<T> : std::is_base_of<Components::IComponentPool, T>
{
};

template<typename T, typename... Ts>
struct all_derived_from_base<T, Ts...>
  : std::conjunction<std::is_base_of<Components::IComponentPool, T>, all_derived_from_base<Ts...>>
{
};
}// namespace ECS::Systems
