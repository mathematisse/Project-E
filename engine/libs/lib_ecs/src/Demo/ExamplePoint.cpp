...
namespace ECS::Entities
{
    ...
    [[nodiscard]] Components::PositionRef *Entities::ExamplePointRef::getPosition() const
    {
        return _position;
    }

    void Entities::ExamplePointRef::setPosition(const Components::PositionRef &position)
    {
        *_position = position;
    }

    [[nodiscard]] Components::VelocityRef *Entities::ExamplePointRef::getVelocity() const
    {
        return _velocity;
    }

    void Entities::ExamplePointRef::setVelocity(const Components::VelocityRef &velocity)
    {
        *_velocity = velocity;
    }
    ...
    std::unique_ptr<Entities::IEntityRef> ExamplePointPool::getEntity(Chunks::ChunkPos cPos)
    {
    ...
    std::unique_ptr<Entities::ExamplePointRef> ExamplePointPool::getRawEntity(Chunks::ChunkPos cPos)
    {
        auto ptr = std::make_unique<Entities::ExamplePointRef>(
            ...
            static_cast<Components::VelocityRef *>(_velocityPool.getComponentRef(cPos))
        );
        return ptr;
    }
