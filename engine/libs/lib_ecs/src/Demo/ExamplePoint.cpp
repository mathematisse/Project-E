...
// ENTITY REF
ExamplePointRef::ExamplePointRef(C::EntityStatusRef *status,
  C::ChunkPosRef *cPos,
...
std::unique_ptr<E::IEntityRef> ExamplePointPool::getEntity(Chunks::ChunkPos cPos) { return getRawEntity(cPos); }

std::unique_ptr<E::ExamplePointRef> ExamplePointPool::getRawEntity(Chunks::ChunkPos cPos)
{
  auto ptr =
    std::make_unique<E::ExamplePointRef>(dynamic_cast<C::EntityStatusRef *>(_entityStatusPool.getComponentRef(cPos)),
