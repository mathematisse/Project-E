...
auto Socket::read(std::span<std::byte> buf) const -> io::Result<std::size_t>
{
...
auto Socket::recv_from(std::span<std::byte> buf
...
auto Socket::write(std::span<std::byte> buf) const -> io::Result<std::size_t>
{
