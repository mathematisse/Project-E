...
std::optional<net::Packet> net::Packet::deserialize(const std::vector<std::byte> &data)
{
    Packet packet;
...
std::optional<net::Packet> net::Packet::deserialize(const std::span<std::byte> &data)
{
    Packet packet;
