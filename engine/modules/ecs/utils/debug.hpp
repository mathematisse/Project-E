...
requires(Index == sizeof...(Types)) auto print_tuple(std::ostream &os, const std::tuple<Types...> &)
    -> std::ostream &
{
    return os;
}
...
template<std::size_t Index = 0, typename... Types>
requires(Index < sizeof...(Types)) constexpr auto print_tuple(std::ostream &os, const std::tuple<Types...> &t)
    -> std::ostream &
{
