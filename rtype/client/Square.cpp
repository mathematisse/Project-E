...
namespace ECS::E
{
    ...
    [[nodiscard]] C::PositionRef *E::SquareRef::getPosition() const
    {
        return _position;
    }

    void E::SquareRef::setPosition(const C::PositionRef &position)
    {
        *_position = position;
    }

    [[nodiscard]] C::VelocityRef *E::SquareRef::getVelocity() const
    {
        return _velocity;
    }

    void E::SquareRef::setVelocity(const C::VelocityRef &velocity)
    {
        *_velocity = velocity;
    }

    [[nodiscard]] C::ColorRef *E::SquareRef::getColor() const
    {
        return _color;
    }

    void E::SquareRef::setColor(const C::ColorRef &color)
    {
        *_color = color;
    }

    [[nodiscard]] C::SizeRef *E::SquareRef::getSize() const
    {
        return _size;
    }

    void E::SquareRef::setSize(const C::SizeRef &size)
    {
        *_size = size;
    }

    [[nodiscard]] C::TypeRef *E::SquareRef::getType() const
    {
        return _type;
    }

    void E::SquareRef::setType(const C::TypeRef &type)
    {
        *_type = type;
    }
