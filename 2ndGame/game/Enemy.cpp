...
namespace ECS::E
{
    ...
    [[nodiscard]] C::PositionRef *E::EnemyRef::getPosition() const
    {
        return _position;
    }

    void E::EnemyRef::setPosition(const C::PositionRef &position)
    {
        *_position = position;
    }

    [[nodiscard]] C::SizeRef *E::EnemyRef::getSize() const
    {
        return _size;
    }

    void E::EnemyRef::setSize(const C::SizeRef &size)
    {
        *_size = size;
    }

    [[nodiscard]] C::SpriteRef *E::EnemyRef::getSprite() const
    {
        return _sprite;
    }

    void E::EnemyRef::setSprite(const C::SpriteRef &sprite)
    {
        *_sprite = sprite;
    }

    [[nodiscard]] C::VelocityRef *E::EnemyRef::getVelocity() const
    {
        return _velocity;
    }

    void E::EnemyRef::setVelocity(const C::VelocityRef &velocity)
    {
        *_velocity = velocity;
    }

    [[nodiscard]] C::HealthRef *E::EnemyRef::getHealth() const
    {
        return _health;
    }

    void E::EnemyRef::setHealth(const C::HealthRef &health)
    {
        *_health = health;
    }
